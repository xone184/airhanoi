...
const AdminPanel: React.FC<AdminPanelProps> = ({
    ...
    const handleFileUpload = async (fileName: string, e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE}/data/upload.php?type=${uploadType}`, {
                method: 'POST',
                headers: {
            ...
            if (uploadType === 'realtime') {
                try {
                    const dataResponse = await fetch(`${API_BASE}/data/air_quality.php?type=realtime`);
                ...
                try {
                    const dataResponse = await fetch(`${API_BASE}/data/air_quality.php?type=forecast`);
                    const dataResult = await dataResponse.json();
                    if (dataResult.success && dataResult.data) {
