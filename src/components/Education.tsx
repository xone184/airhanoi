...
const Education: React.FC = () => {
    ...
    return (
        <div className="p-6 lg:p-10 animate-fade-in h-full overflow-y-auto relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-12">
                {pollutants.map((p, idx) => (
                    <div
                        ...
                        className="glass-panel rounded-xl overflow-hidden cursor-pointer group hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-1 shadow-lg"
                    >
                        {/* Image Header */}
            ...
            <div className="bg-slate-900 rounded-xl border border-slate-700 overflow-hidden shadow-xl mb-20">
            ...
            {selectedItem && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    {/* Modal Content */}
                    <div className="bg-slate-900 rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative z-10 border border-slate-700 shadow-2xl flex flex-col md:flex-row animate-fade-in-up">
                        <button
                            onClick={() => setSelectedItem(null)}
