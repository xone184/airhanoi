...
function handleLogin() {
    ...
    if (!password_verify($password, $user['password_hash'])) {
        ...
        error_log("Password verification failed for user: $username. Hash: " . substr($user['password_hash'], 0, 30) . "...");
        sendError('Invalid credentials - Password không khớp. Vui lòng kiểm tra lại password hoặc reset password hash.', 401);
    }
